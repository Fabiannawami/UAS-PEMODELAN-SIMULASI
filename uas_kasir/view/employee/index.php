...
<html lang="en">
    <head>
        ...
        <title>UAS PEMODELAN SIMULASI</title>
    </head>
    <body>
        <div class="container">
            <div id="message">
    ...
    <p>Gerai MCD melakukan percobaan awal waktu pelayanan
        <b id="total"></b>
        kemudian, dari hasil pemodelan logika fuzzy dapat disimpulkan sebagai berikut :
        <ul>
            <li id="SKR"></li>
            <li id="SK"></li>
            <li id="SKA"></li>
      ...
      $(document).ready(function () {
        ...
        $('#generate').click(function () {
            ...
            $.ajax({
                ...
                url: "http://localhost/uas_kasir/api/operasi/generate-by-avg.php",
                success: function (response) {
                        // Update modal content based on fuzzy logic conclusion
                        $('#id').val(response.id);
                        $('#SKR').append(response.selisih_kedatangan);
                        $('#SK').append(response.selisih_pelayanan_kasir);
                        $('#SKA').append(response.selisih_keluar_antrian);  
                    },
                    error: function(err) {
                console.log(err);
            }
        ...
        $('#sample_form').on('submit', function(event){
            ...
            if ($('#action').val() == "Add") {
                ...
                $.ajax({
                    url: "http://localhost/uas_kasir/api/operasi/create.php",
                    method: "POST",
                    ...
                    $.ajax({
                        url:"http://localhost/uas_kasir/api/operasi/update.php",
                        method:"PUT",
                        data: JSON.stringify(formData),
                        success:function(data){
                            $('#action_button').attr('disabled', false);
    ...
    $.ajax({
        type: "GET",
        contentType: "application/json",
        url: "http://localhost/uas_kasir/api/operasi/read.php",
        success: function (response) {
            $('#total').html('');
        ...
        function showOne(id) {
            ...
            $.ajax({
                    type: "GET",
                    contentType: "application/json",
                    url: "http://localhost/uas_kasir/api/operasi/read.php?id="+id,
                    success: function(response) { 
                        $('#id').val(response.id);
        ...
        function deleteOne(id) {
            ...
            $.ajax({
                url:"http://localhost/uas_kasir/api/operasi/delete.php",
                method:"DELETE",
